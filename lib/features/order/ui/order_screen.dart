...
class _OrderScreenState extends State<OrderScreen> {
  ...
  @override
  void dispose() {
    _symbolCtrl.dispose(); _entryCtrl.dispose(); _slCtrl.dispose();
    super.dispose();
  }
          ...
          if (state is OrderSuccess) {
            ScaffoldMessenger.of(ctx).showSnackBar(SnackBar(
              content: const Row(children: [
                ...
                SizedBox(width: 8), Text('Order sent successfully!'),
              ]),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Row(children: [
                      Icon(Icons.candlestick_chart, color: AppTheme.primary, size: 28),
                      SizedBox(width: 12),
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('Alpaca Trading Bot',
                          style: TextStyle(color: AppTheme.text1, fontWeight: FontWeight.bold, fontSize: 15)),
                  ...
                  if (state is OrderSuccess) ...[
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Row(children: [
                            Icon(Icons.check_circle, color: AppTheme.profit, size: 18),
                            SizedBox(width: 8),
                            Text('Order Response', style: TextStyle(color: AppTheme.profit, fontWeight: FontWeight.bold)),
                          ]),
                          ...
                          ...state.result.entries
                              ...
                              .map((e) => Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(e.key, style: const TextStyle(color: AppTheme.text2, fontSize: 12)),
