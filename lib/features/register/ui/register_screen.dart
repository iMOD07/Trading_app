        ...
        listener: (ctx, state) {
          if (state is RegisterSuccess) {
            ScaffoldMessenger.of(ctx).showSnackBar(const SnackBar(
              content: Text('✅ Account created! Waiting for admin activation.'),
            ...
            body: Form(
              ...
              child: ListView(
                ...
                children: [
                          ...
                          children: [
                            Text('New Account',
                                style: TextStyle(
                                    ...
                                    fontSize: 15)),
                            Text('Account will be activated by admin',
                                style: TextStyle(
                          ...
                          children: [
                            Text('Ibkr Setings',
                                style: TextStyle(
                                    ...
                                    fontSize: 15)),
                            Text(
                                'Your account information on the platform IBKR',
                                style: TextStyle(
                                    color: AppTheme.text2, fontSize: 12)),
                          ]),
                    ]),
                  ...
                  // const SizedBox(height: 14),
                  // _label('Account'),
                  // _textField(_accountCtrl, 'DUN294...', required: true),

                  // const SizedBox(height: 14),
                  // _label('Client ID'),
                  // _textField(_clientIdCtrl, '1', required: true),

                  // const SizedBox(height: 14),
                  // _label('Port'),
                  // _textField(_portCtrl, '7497', required: true),

                  // const SizedBox(height: 14),
                  // _label('Host'),
                  // _textField(_hostCtrl, '127.0.0.1', required: true),
